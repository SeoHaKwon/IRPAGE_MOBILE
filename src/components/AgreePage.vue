      ...
      <div class="pop-cont">
        ...
        <div class="pop-inner">
          ...
          <div class="desc">
            ...
            <strong class="num">제 {{ idx + 1 }} 조({{ item.subtitle }})</strong>
              <p v-html="item.desc"/>
            </div>
            <p v-html="dataList[selNum].bottomData"/>
          </div>
        </div>
      </div>
    </div>
